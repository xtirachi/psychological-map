document.getElementById('questionnaire').addEventListener('submit', function(e) {
    ...
    const highestScore = Math.max(scores.linguistic, scores.logicalMathematical, scores.bodilyKinesthetic, scores.naturalist, scores.spatial);
    ...
    const docDefinition = {
        content: [
            ...
            { text: intelligenceDetails[predominantIntelligence], style: 'details' }
        ],
        styles: {
